...
class PresentacionController extends Controller
{
    ...
    public function crearsimple(Request $request)
    {
        ...
        $presentacion = null;
        $formData = array('presentacion.guardarsimple');
        $formData = array('route' => $formData, 'class' => 'form-horizontal', 'id' => 'formMantenimiento'.$entidad, 'autocomplete' => 'off');
        $boton    = 'Registrar'; 
        return view($this->folderview.'.mantSimple')->with(compact('presentacion', 'formData', 'entidad', 'boton', 'listar'));
    }
    ...
    public function guardarsimple(Request $request)
    {
        ...
        $error = DB::transaction(function() use($request,&$dat){
            ...
            $presentacion->nombre = strtoupper($request->input('nombre'));
            $presentacion->save();
            $dat[0]=array("respuesta"=>"OK","id"=>$presentacion->id,"nombre"=>$presentacion->nombre); 
        });
        return is_null($error) ? json_encode($dat) : $error;
    }

    public function autocompletarpresentacion($searching)
    {
        $entidad   = 'Presentacion';
        $mdlPresentacion = new Presentacion();
        $resultado = Presentacion::where('nombre', 'LIKE', '%'.strtoupper($searching).'%')->orderBy('nombre', 'ASC');
        $lista     = $resultado->get();
        $data      = array();
    ...
    public function buscar(Request $request)
    {
        ...
        $resultado        = Presentacion::where('nombre', 'LIKE', '%'.strtoupper($nombre).'%')->orderBy('nombre', 'ASC');
        $lista            = $resultado->get();
        $cabecera         = array();
    ...
    public function eliminar($id, $listarLuego)
    {
        ...
        $entidad  = 'Presentacion';
        $mensaje = '¿Desea eliminar la presentacion "'.$modelo->nombre.'" ? <br><br>';
