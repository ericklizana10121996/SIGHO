...
class ReciboblancoController extends Controller
{
    ...
    public function pdfRecibo(Request $request){
        ...
        $pdf::Ln();
        $pdf::SetFont('helvetica','B',9);
        $pdf::Cell(30,7,utf8_decode("REGISTRADO EL :"),0,0,'L');
        $pdf::SetFont('helvetica','',9);
        $pdf::Cell(70,7,date('d/m/Y H:i a', strtotime($lista->created_at)),0,0,'L');
        $pdf::SetFont('helvetica','B',9);
 
        $pdf::Cell(30,7,utf8_decode("REGISTRADO EL :"),0,0,'L');
        $pdf::SetFont('helvetica','',9);
        $pdf::Cell(80,7,date('d/m/Y H:i a', strtotime($lista->created_at)),0,0,'L');
