					...
					<div class="row">
						<div class="col-xs-12">
                            ...
                            <div class="form-group">
								...
								{!! Form::select('piso', $cboPiso , null, array('class' => 'form-control input-xs', 'id' => 'piso', 'onchange' => 'buscar(\''.$entidad.'\')')) !!}
							</div>
                            <div class="form-group">
								{!! Form::label('tipohabitacion', 'Tipo Hab.:') !!}
								{!! Form::select('tipohabitacion', $cboTipoHabitacion , null, array('class' => 'form-control input-xs', 'id' => 'tipohabitacion', 'onchange' => 'buscar(\''.$entidad.'\')')) !!}
							</div>
							<div class="form-group">
