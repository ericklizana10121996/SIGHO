...
if(is_null($reciboblanco)){
    ...
    $responsable = $reciboblanco->responsableGarantia;
}
?>
...
{!! Form::model($reciboblanco, $formData) !!}	
	{!! Form::hidden('listar', $listar, array('id' => 'listar')) !!}
        ...
        <!--
        <div class="form-group">
        {!! Form::label('responsable', 'Responsable: ', array('class' => 'col-lg-2 col-md-2 col-sm-2 control-label')) !!}
            <div class="col-lg-10 col-md-10 col-sm-10">
                {!! Form::text('responsable', $responsable, array('class' => 'form-control input-xs', 'id' => 'responsable')) !!}
            </div>
        </div>
        -->
        <div class="form-group">   
