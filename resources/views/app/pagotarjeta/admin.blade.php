...
<script>
	...
	function imprimirReporte(){
        window.open("pagotarjeta/pdfReporte?doctor="+$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="nombre"]').val()+"&fechafinal="+$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="fechafinal"]').val()+"&fechainicial="+$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="fechainicial"]').val()+"&situacion="+$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="situacion"]').val(),"_blank");
    }

    function excel(entidad){
	    window.open("pagotarjeta/excel?doctor="+$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="nombre"]').val()+"&fechafinal="+$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="fechafinal"]').val()+"&fechainicial="+$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="fechainicial"]').val()+"&situacion="+$(IDFORMBUSQUEDA + '{{ $entidad }} :input[id="situacion"]').val(),"_blank");
	}
</script>