...
{!! $mensaje or '<blockquote><p class="text-danger">Ingrese el comentario:</p></blockquote>' !!}
<div class="form-group">
	<div class="col-lg-12 col-md-12 col-sm-12 text-right">
		{!! Form::hidden('id', $id) !!}
		{!! Form::text('comentarioa', $modelo->listapago, ['class' => 'form-control', 'placeholder' => 'Comentario']) !!}
