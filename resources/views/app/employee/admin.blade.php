				...
				<div class="box-header">
					<div class="row">
						<div class="col-xs-12">
							...
							{!! Form::button('<i class="glyphicon glyphicon-plus"></i> Agregar paciente', array('class' => 'btn btn-primary btn-xs', 'id' => 'btnNuevo', 'onclick' => 'modal (\''.URL::route($ruta["validar"], array('listar'=>'SI')).'\', \''.$titulo_registrar.'\', this);')) !!}
							{!! Form::close() !!}
						</div>
					</div>
				</div>
