					...
					<div class="row">
						<div class="col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('area', $cboArea, null, array('class' => 'form-control input-xs', 'id' => 'area')) !!}
                            </div>
                            <div class="form-group">
							...
							<div class="form-group">
                                ...
                                {!! Form::select('situacion', $cboSituacion, 'E', array('class' => 'form-control input-xs', 'id' => 'situacion', 'onchange' => 'buscar(\''.$entidad.'\')')) !!}
                            </div>
