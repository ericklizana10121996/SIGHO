...
{!! Form::model($venta, $formData) !!}	
	...
	<div class="col-lg-4 col-md-4 col-sm-4">
		...
		<div class="form-group" style="height: 12px;">
			{!! Form::label('formapago', 'Forma Pago:', array('class' => 'col-lg-4 col-md-4 col-sm-4 control-label')) !!}
			<div class="col-lg-7 col-md-7 col-sm-7">
	...
	<div class="col-lg-8 col-md-8 col-sm-8">
		<div class="form-group" style="height: 12px;">
			...
			<div class="col-lg-2 col-md-2 col-sm-2">
				{!! Form::text('cantidad', null, array('class' => 'form-control input-xs', 'id' => 'cantidad', 'onkeypress'=>'return solo_numero(event);')) !!}
			</div>
