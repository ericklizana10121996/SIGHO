<?php
$doctor=$detalle->socio->apellidopaterno.' '.$detalle->socio->apellidomaterno.' '.$detalle->socio->nombres;
...
{!! Form::model($detalle, $formData) !!}	
	...
	<div class="form-group">
		<div class="col-lg-12 col-md-12 col-sm-12 text-right">
			{!! Form::button('<i class="fa fa-check fa-lg"></i> '.$boton, array('class' => 'btn btn-success btn-sm', 'id' => 'btnGuardar', 'onclick' => 'if($("#recibo").val()!=""){guardar(\''.$entidad.'\', this);}else{alert("Debe registrar el RH");}')) !!}
