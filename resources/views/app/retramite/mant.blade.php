        ...
        $.ajax({
            ...
            success: function(a) {
                ...
                $("#tbDetalle").append("<tr id='tr"+datos[c].id+"'><td><input type='hidden' id='txtId"+datos[c].id+"' name='txtId"+datos[c].id+"' value='"+datos[c].id+"' />"+datos[c].fecha+"</td>"+
                    ...
                    "<td><input class='chkRetencion' id='chkRetencion"+datos[c].id+"' type='checkbox' onchange='calcularRetencion($(this).is(\":checked\"),"+datos[c].id+")' /></td>"+
                    ...
                    "<td><input class='chkDetraccion' type='checkbox' id='chkDetraccion"+datos[c].id+"' onchange='calcularDetraccion($(this).is(\":checked\"),"+datos[c].id+")' /></td>"+
