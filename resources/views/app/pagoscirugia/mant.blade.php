    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <div class="form-group">
                ...
                {!! Form::text('cirugia', $nombre, array('class' => 'form-control input-xs', 'id' => 'cirugia', 'placeholder' => 'Ingrese Cirugia', 'required')) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                {!! Form::text('medico_cabecera', $nombre_medico_cabecera, array('class' => 'form-control input-xs', 'id' => 'medico_cabecera', 'placeholder' => 'Ingrese Médico')) !!}
                </div>
            </div>
            ...
            <div class="form-group">
        		...
        		{!! Form::text('paciente', $nombre_paciente, array('class' => 'form-control input-xs', 'id' => 'paciente', 'placeholder' => 'Ingrese Paciente')) !!}
        		</div>
        	</div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                {!! Form::date('fecha_cirugia', $fecha_cirugia, array('class' => 'form-control input-xs', 'id' => 'fecha_cirugia')) !!} </div>

                {!! Form::label('hora_cirugia', 'Hora Cirugía:', array('class' => 'col-lg-2 col-md-2 col-sm-2 control-label')) !!}
                <div class="col-lg-3 col-md-3 col-sm-3" style="margin-top:5px;">
                {!! Form::time('hora_cirugia', $hora_cirugia, array('class' => 'form-control input-xs', 'id' => 'hora_cirugia')) !!} </div>
            </div>
            ...
            success: function(a) {
                ...
                for( var c= 0; c < a.length; c++){
                   ...
                   $("#tbDetalle").append("<tr id='tr"+id+"'><td><input type='hidden' id='txtIdTipoServicio"+id+"' name='txtIdTipoServicio"+id+"' value='0' /><input type='text' data='numero' class='form-control input-xs' id='txtCantidad"+id+"' name='txtCantidad"+id+"' style='width: 40px;' value='1' size='3' onkeydown=\"if(event.keyCode==13){calcularTotal()}\" onblur=\"calcularTotalItem2('"+id+"')\" /></td>"+
                    ...
                    "<td><textarea class='form-control input-xs' id='txtServicio"+id+"' name='txtServicio"+id+"' /></td>"+
                    "<td><input type='hidden' id='txtPrecio2"+id+"' name='txtPrecio2"+id+"' value='' min='0'/><input type='text' size='5' class='form-control input-xs' style='width: 60px;' data='numero' id='txtPrecio"+id+"' min='0' name='txtPrecio"+id+"' value='' onkeydown=\"if(event.keyCode==13){calcularTotalItem2('"+id+"')}\" onblur=\"calcularTotalItem2('"+id+"')\" /></td>"+
                    "<td><input type='text' style='width: 60px;' readonly='' data='numero' class='form-control input-xs' size='5' name='txtTotal"+id+"' id='txtTotal"+id+"' value=0' /></td>"+
                    "<td><a href='#' onclick=\"quitarServicio('"+id+"')\"><i class='fa fa-minus-circle' title='Quitar' width='20px' height='20px'></i></td></tr>");
