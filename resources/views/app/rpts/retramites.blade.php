...
<section class="content">
						...
						<div class="col-xs-12">
                            ...
                            <div class="form-group">
  						    ...
  						    <div class="form-group">
								...
								{!! Form::text('documento', null, array('class' => 'form-control input-xs', 'id' => 'documento', 'placeholder' => 'Nro de Factura')) !!}
							</div>
 ...
 --}}
							...
							{!! Form::button('<i class="glyphicon glyphicon-plus"></i> Nuevo', array('class' => 'btn btn-primary btn-xs', 'id' => 'btnBuscar', 'onclick' => 'modal (\''.URL::route($ruta["create2"], array('listar'=>'SI')).'\', \''.$titulo_registrar.'\', this);')) !!}
...
<script>
	...
	function Genera2(){
		...
		// if (ff != "") {
		var link = 'reporte.php?rep=126&fi='+fi+'&ff='+ff+'&doc='+documento;
