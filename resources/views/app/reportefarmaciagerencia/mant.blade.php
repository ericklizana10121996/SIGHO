...
if(!is_null($Movimientocaja)){
    ...
    $area_id=$Movimientocaja->area_id;
    $total=number_format($Movimientocaja->total,2,'.','');
    $id=$Movimientocaja->id;
    $comentario=$Movimientocaja->comentario;
}
?>
...
{!! Form::model($Movimientocaja, $formData) !!}	
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="form-group">
                {!! Form::label('area', 'Area:', array('class' => 'col-lg-3 col-md-3 col-sm-3 control-label')) !!}
                <div class="col-lg-5 col-md-5 col-sm-5">
                    {!! Form::select('area', $cboArea, $area_id, array('class' => 'form-control input-xs', 'id' => 'area')) !!}
                </div>
            </div>
            <div class="form-group">
                {!! Form::label('comentario', 'Comentario:', array('class' => 'col-lg-3 col-md-3 col-sm-3 control-label')) !!}
                <div class="col-lg-4 col-md-4 col-sm-4">
                    {!! Form::textarea('comentario', $comentario, array('class' => 'form-control input-xs', 'id' => 'comentario')) !!}
                </div>
