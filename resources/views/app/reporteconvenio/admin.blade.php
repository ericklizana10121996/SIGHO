...
<script>
	...
	function excel(entidad){
	    window.open("reporteconvenio/excel?fechainicial="+$(IDFORMBUSQUEDA + '{!! $entidad !!} :input[name="fechainicial"]').val()+"&fechafinal="+$(IDFORMBUSQUEDA + '{!! $entidad !!} :input[name="fechafinal"]').val()+"&paciente="+$(IDFORMBUSQUEDA + '{!! $entidad !!} :input[name="paciente"]').val()+"&plan="+$(IDFORMBUSQUEDA + '{!! $entidad !!} :input[name="plan"]').val()+"&tipopaciente="+$(IDFORMBUSQUEDA + '{!! $entidad !!} :input[name="tipopaciente"]').val()+"&_token="+$(IDFORMBUSQUEDA + '{!! $entidad !!} :input[name="_token"]').val(),"_blank");
	}
</script>