    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database'  => env('DB_DATABASE', 'sanpablo'),
            'username'  => env('DB_USERNAME', 'root'),
            'password'  => env('DB_PASSWORD', 'juanpablo*2017'),
            'charset'   => 'utf8',
        ...
        'sqlsrvtst21' => [
            'driver'   => 'sqlsrv',
            'host'     => env('DB_HOST_SQLSRVTST21', 'localhost'),
            'database' => env('DB_DATABASE_SQLSRVTST21', 'forge'),
            'username' => env('DB_USERNAME_SQLSRVTST21', 'forge'),
            'password' => env('DB_PASSWORD_SQLSRVTST21', ''),
            'charset'  => 'utf8',
            'prefix'   => '',
        ],
